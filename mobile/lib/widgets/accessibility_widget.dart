    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _toggleBtn(
                ...
                () => provider.updatePreferences({'fontSize': 'small'}),
                fontSize: 12,
              ),
              const SizedBox(width: 8),
              _toggleBtn(
                ...
                () => provider.updatePreferences({'fontSize': 'medium'}),
                fontSize: 15,
              ),
              const SizedBox(width: 8),
              _toggleBtn(
                ...
                () => provider.updatePreferences({'fontSize': 'large'}),
                fontSize: 20,
              ),
            ],
          ),
          ...
          _sectionTitle(
            context,
            provider.preferences['theme'] == 'dark'
                ? Icons.dark_mode
                : Icons.light_mode,
            'Theme Design',
          ),
          ...
          Row(
            children: [
              _toggleBtn(
                context,
                provider.dyslexiaFont ? 'ON ✓' : 'OFF',
                provider.dyslexiaFont,
                () => provider.updatePreferences({
                  'dyslexiaFont': !provider.dyslexiaFont,
                }),
              ),
              const Spacer(flex: 2),
            ],
  ...
  Widget _colorBtn(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active
              ? const Color(0xFFF79C42).withOpacity(0.15)
              : cs.surface,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: active ? const Color(0xFFF79C42) : cs.outline,
